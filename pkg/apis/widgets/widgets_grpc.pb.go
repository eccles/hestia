...
func (c *widgetsClient) Create(ctx context.Context, in *CreateRequest, opts ...grpc.CallOption) (*Widget, error) {
	out := new(Widget)
	err := c.cc.Invoke(ctx, Widgets_Create_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *widgetsClient) FindByID(ctx context.Context, in *FindRequest, opts ...grpc.CallOption) (*Widget, error) {
	out := new(Widget)
	err := c.cc.Invoke(ctx, Widgets_FindByID_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *widgetsClient) List(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	err := c.cc.Invoke(ctx, Widgets_List_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *widgetsClient) Update(ctx context.Context, in *UpdateRequest, opts ...grpc.CallOption) (*Widget, error) {
	out := new(Widget)
	err := c.cc.Invoke(ctx, Widgets_Update_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *widgetsClient) Delete(ctx context.Context, in *DeleteRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, Widgets_Delete_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
